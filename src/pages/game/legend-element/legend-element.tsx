 ...
 * @param {string} props.dataAtridyt - Значение data-атрибута для группировки и стилизации
 ...
 *   xCoord={2} 
 *   yCoord={3} 
 *   dataAtridyt="LegendHorizontal_2" 
 * />
 */
const LegendElement: FC<ILegendElement> = ({ text, xCoord, yCoord, dataAtridyt }) => {
    // Получаем функцию регистрации элемента из хранилища легенд
    const { getLegendElement } = legendStore();
    ...
    return <div ref={ref} className={`${styles.le} ${style}`} data-type={dataAtridyt}>{text}</div>;
};
