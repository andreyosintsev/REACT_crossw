...
import { loadTaskFromLocalStorage, clearBoardInLocalStorage } from "../../utils/local-storage";
        ...
        verticalLegend && (
            <>
                <div className={TableStyles.table} style={{ minWidth: `${(verticalLegend.width + task.width) * 25 + 4}px` }}>
                    <BoardZeroField className={TableStyles.zero_field} width={verticalLegend.width} height={horizontalLegend.height} />
                    <LegendHorizontal legend={horizontalLegend.legend} width={horizontalLegend.width} />
                    <div className={TableStyles.new_line} />
                    <LegendVertical legend={verticalLegend.legend} width={verticalLegend.width} />
                    <Board width={task.width} height={task.height} task={task.task} checkWin={checkWin} help={help} />
                </div>
                {modalShow && (
